...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="view"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Notes Details</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-subjects_id">
                                        <th class="title"> Subjects Id: </th>
                                        <td class="value"> <?php echo $data['subjects_id']; ?></td>
                                    </tr>
                                    <tr  class="td-subjects_subject">
                                        <th class="title"> Subjects Subject: </th>
                                        <td class="value"> <?php echo $data['subjects_subject']; ?></td>
                                    </tr>
                                    <tr  class="td-subjects_code">
                                        <th class="title"> Subjects Code: </th>
                                        <td class="value"> <?php echo $data['subjects_code']; ?></td>
                                    </tr>
                                    <tr  class="td-subjects_date_created">
                                        <th class="title"> Subjects Date Created: </th>
                                        <td class="value"> <?php echo $data['subjects_date_created']; ?></td>
                                    </tr>
                                    <tr  class="td-subjects_date_updated">
                                        <th class="title"> Subjects Date Updated: </th>
                                        <td class="value"> <?php echo $data['subjects_date_updated']; ?></td>
                                    </tr>
                                    <tr  class="td-subjects_subject_group">
                                        <th class="title"> Subjects Subject Group: </th>
                                        <td class="value"> <?php echo $data['subjects_subject_group']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
