                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-adm_no"  value="<?php  echo $data['adm_no']; ?>" type="text" placeholder="Enter Adm No"  required="" name="adm_no"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-stream"  value="<?php  echo $data['stream']; ?>" type="text" placeholder="Enter Stream"  required="" name="stream"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-kcpe"  value="<?php  echo $data['kcpe']; ?>" type="text" placeholder="Enter Kcpe"  required="" name="kcpe"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
