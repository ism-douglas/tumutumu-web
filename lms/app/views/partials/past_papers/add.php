                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-exam_year"  value="<?php  echo $this->set_field_value('exam_year',""); ?>" type="text" placeholder="Enter Exam Year"  required="" name="exam_year"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-exam_type"  value="<?php  echo $this->set_field_value('exam_type',""); ?>" type="text" placeholder="Enter Exam Type"  required="" name="exam_type"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
