                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-subject_group"  value="<?php  echo $data['subject_group']; ?>" type="text" placeholder="Enter Subject Group"  required="" name="subject_group"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
