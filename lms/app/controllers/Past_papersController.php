...
class Past_papersController extends BaseController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("subject","exam_year","term","level","views","uploaded_by","document","date_created","date_updated","paper_type","exam_type");
...
$db->rawQuery("UPDATE past_papers SET uploaded_by = $USER_ID  WHERE id='$rec_id'");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","subject","exam_year","term","level","views","uploaded_by","document","date_created","date_updated","paper_type","exam_type");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'subject' => 'required',
