                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-resource_name"  value="<?php  echo $this->set_field_value('resource_name',""); ?>" type="text" placeholder="eg. Calculus or County Mock PP2"  required="" name="resource_name"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
